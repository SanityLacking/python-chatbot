...
def train():
      ...
      bot.train([
        ...
        '유학 신청과정은 아래의 웹에 자세히 나와 있습니다.: http://www.eduhouse.net/talk/talk_guide_univ.asp',
        'information application yuhak',
        '유학 신청과정은 아래의 웹에 자세히 나와 있습니다.: http://www.eduhouse.net/talk/talk_guide_univ.asp',
        'what do I do for Yuhak',
        '유학 신청과정은 아래의 웹에 자세히 나와 있습니다.: http://www.eduhouse.net/talk/talk_guide_univ.asp',
        'how to prepare for Yuhak',
        '유학 신청과정은 아래의 웹에 자세히 나와 있습니다.: http://www.eduhouse.net/talk/talk_guide_univ.asp',
        'when is the application deadline',
        '유학 신청마감,유학 신청과정은 아래의 웹에 자세히 나와 있습니다.: http://www.eduhouse.net/talk/talk_guide_univ.asp',
        'How much english score do I need',
        ...
        'english university without IELTS',
        ...
        'english university without TOEFL',
        '만약 현재 본인이 충분한 영어실력이 있다면 가장 좋은 방법은 IELTS나 TOEFL과 같은 공식 영어시험에 응시하여 점수를 취득하는 것이 가장 좋습니다. 그러나 현재 영어실력이 부족하다면 진학하고자 하는 대학 내 대학부설 영어과정이나 해당 대학과 연계되어 있는 사설 영어교육기관에서 영어연수과정을 수강한 후 대학으로 진학할 수 있습니다. 이 경우 대학입학을 위해 정해진 레벨을 마치면 IELTS나 TOEF과 같은 공식 영어시험 제출 없이 진학할 수 있습니다.',
        'lower engish score',
        '만약 현재 본인이 충분한 영어실력이 있다면 가장 좋은 방법은 IELTS나 TOEFL과 같은 공식 영어시험에 응시하여 점수를 취득하는 것이 가장 좋습니다. 그러나 현재 영어실력이 부족하다면 진학하고자 하는 대학 내 대학부설 영어과정이나 해당 대학과 연계되어 있는 사설 영어교육기관에서 영어연수과정을 수강한 후 대학으로 진학할 수 있습니다. 이 경우 대학입학을 위해 정해진 레벨을 마치면 IELTS나 TOEF과 같은 공식 영어시험 제출 없이 진학할 수 있습니다.',
        'not enough engish score',
        '만약 현재 본인이 충분한 영어실력이 있다면 가장 좋은 방법은 IELTS나 TOEFL과 같은 공식 영어시험에 응시하여 점수를 취득하는 것이 가장 좋습니다. 그러나 현재 영어실력이 부족하다면 진학하고자 하는 대학 내 대학부설 영어과정이나 해당 대학과 연계되어 있는 사설 영어교육기관에서 영어연수과정을 수강한 후 대학으로 진학할 수 있습니다. 이 경우 대학입학을 위해 정해진 레벨을 마치면 IELTS나 TOEF과 같은 공식 영어시험 제출 없이 진학할 수 있습니다.',
        'recommend prestigious australian universities',
        ...
        'recommend high level australian universities',
        '호주에는 호주의 아이비리그라고 알려진 그룹 오브 에이트(Group of Eight, Go8) 대학들이 있습니다. 호주 대학 랭킹에서 늘 1윌부터 8위까지를 차지하는 8개 대학으로 호주 국립대학교(Australian National University, ANU), 뉴 사우스 웨일즈 대학교(University of New South Wales, UNSW), 퀸즐랜드 대학교(University of Queensland, UQ), 모나쉬 대학교(Monash University), 서호주 대학교(University of Western Australia, UWA), 아들레이드 대학교(University of Adelaide), 시드니 대학교(University of Sydney), 멜번 대학교(University of Melbourne)입니다. 이 8개 대학은 모든 교육과정이 전반적으로 수준이 높고 우수하며, 분야별 대학 랭킹에서도 각 분야에서 상위권에 올라있습니다. 그러나 일부 특정한 학과나 분야에서는 이 대학보다 상위에 랭크 되어 있는 다른 유명한 대학들도 있습니다. 예를 들어 호텔관광(Hospitality) 분야에서는 그리피스 대학교(Griffith University), 스포츠 과학(Sport Science) 분야에서는 디킨 대학교(Deakin University)가 호주 내 1위로 가장 유명합니다.',
        'recommend good Australian universities',
        '호주에는 호주의 아이비리그라고 알려진 그룹 오브 에이트(Group of Eight, Go8) 대학들이 있습니다. 호주 대학 랭킹에서 늘 1윌부터 8위까지를 차지하는 8개 대학으로 호주 국립대학교(Australian National University, ANU), 뉴 사우스 웨일즈 대학교(University of New South Wales, UNSW), 퀸즐랜드 대학교(University of Queensland, UQ), 모나쉬 대학교(Monash University), 서호주 대학교(University of Western Australia, UWA), 아들레이드 대학교(University of Adelaide), 시드니 대학교(University of Sydney), 멜번 대학교(University of Melbourne)입니다. 이 8개 대학은 모든 교육과정이 전반적으로 수준이 높고 우수하며, 분야별 대학 랭킹에서도 각 분야에서 상위권에 올라있습니다. 그러나 일부 특정한 학과나 분야에서는 이 대학보다 상위에 랭크 되어 있는 다른 유명한 대학들도 있습니다. 예를 들어 호텔관광(Hospitality) 분야에서는 그리피스 대학교(Griffith University), 스포츠 과학(Sport Science) 분야에서는 디킨 대학교(Deakin University)가 호주 내 1위로 가장 유명합니다.',
        'recommend universities',
        '호주에는 호주의 아이비리그라고 알려진 그룹 오브 에이트(Group of Eight, Go8) 대학들이 있습니다. 호주 대학 랭킹에서 늘 1윌부터 8위까지를 차지하는 8개 대학으로 호주 국립대학교(Australian National University, ANU), 뉴 사우스 웨일즈 대학교(University of New South Wales, UNSW), 퀸즐랜드 대학교(University of Queensland, UQ), 모나쉬 대학교(Monash University), 서호주 대학교(University of Western Australia, UWA), 아들레이드 대학교(University of Adelaide), 시드니 대학교(University of Sydney), 멜번 대학교(University of Melbourne)입니다. 이 8개 대학은 모든 교육과정이 전반적으로 수준이 높고 우수하며, 분야별 대학 랭킹에서도 각 분야에서 상위권에 올라있습니다. 그러나 일부 특정한 학과나 분야에서는 이 대학보다 상위에 랭크 되어 있는 다른 유명한 대학들도 있습니다. 예를 들어 호텔관광(Hospitality) 분야에서는 그리피스 대학교(Griffith University), 스포츠 과학(Sport Science) 분야에서는 디킨 대학교(Deakin University)가 호주 내 1위로 가장 유명합니다.',
        'bachelor degree',
        '호주에는 호주의 아이비리그라고 알려진 그룹 오브 에이트(Group of Eight, Go8) 대학들이 있습니다. 호주 대학 랭킹에서 늘 1윌부터 8위까지를 차지하는 8개 대학으로 호주 국립대학교(Australian National University, ANU), 뉴 사우스 웨일즈 대학교(University of New South Wales, UNSW), 퀸즐랜드 대학교(University of Queensland, UQ), 모나쉬 대학교(Monash University), 서호주 대학교(University of Western Australia, UWA), 아들레이드 대학교(University of Adelaide), 시드니 대학교(University of Sydney), 멜번 대학교(University of Melbourne)입니다. 이 8개 대학은 모든 교육과정이 전반적으로 수준이 높고 우수하며, 분야별 대학 랭킹에서도 각 분야에서 상위권에 올라있습니다. 그러나 일부 특정한 학과나 분야에서는 이 대학보다 상위에 랭크 되어 있는 다른 유명한 대학들도 있습니다. 예를 들어 호텔관광(Hospitality) 분야에서는 그리피스 대학교(Griffith University), 스포츠 과학(Sport Science) 분야에서는 디킨 대학교(Deakin University)가 호주 내 1위로 가장 유명합니다.',
        'can get job after finish study',
        ...
        '기본적으로 호주에서 2년 이상의 학업을 마치면 일정 기간의 취업비자를 받아서 합법적으로 일을 할 수 있습니다. 학사과정이나 수업위주의 석사과정(Coursework)을 마치면 2년, 연구석사과정(Research)이나 박사과정을 마치면 4년의 취업비자를 받을 수 있습니다. TAFE에서 2년 이상의 과정을 마친 경우에는 본인이 공부한 분야의 기술 평가(skills assessment)를 통과한 경우 1년 6개월의 취업비자를 받을 수 있습니다.',
        'finish high school in korea australia university',
        ...
        'can work while study',
        '학생비자로 호주에서 공부하고 있다면 주당 20시간 동안 일을 할 수 있으며, 방학 기간에는 풀타임으로 일할 수 있습니다. 그러나 관광비자로 12주 미만의 학업을 수행할 때는 일할 수 없습니다.',
        'study in australia',
        '학생비자로 호주에서 공부하고 있다면 주당 20시간 동안 일을 할 수 있으며, 방학 기간에는 풀타임으로 일할 수 있습니다. 그러나 관광비자로 12주 미만의 학업을 수행할 때는 일할 수 없습니다.',
        ...
        'international student middle school',
        '호주 교육부를 통해서 공립학교에 입학할 수 있습니다. 단, 공립학교는 지역별로 학업수준이 크게 다를 수 있습니다. 따라서 생활비가 좀 더 들더라도 좋은 지역으로 가서 학업수준이 높은 학교에 다닐 수 있도록 할 것을 권장합니다.',
        'school entrance',
        '호주 교육부를 통해서 공립학교에 입학할 수 있습니다. 단, 공립학교는 지역별로 학업수준이 크게 다를 수 있습니다. 따라서 생활비가 좀 더 들더라도 좋은 지역으로 가서 학업수준이 높은 학교에 다닐 수 있도록 할 것을 권장합니다.',
        'after australia high school university other country',
        ...
        'after australia high school university usa',
        '가능합니다. 그러나 각 국가에서 요구하는 특정한 입학조건이 있을 경우 미리 준비해야 합니다. 예를 들어 미국과 같은 경우 우수한 대학들은 대부분 SAT 점수를 요구하기 때문에 SAT 시험을 미리 준비해야 하며, 이는 한국에서 해외대학으로 진학할 때도 마찬가지 입니다.',
        'after australia high school university canada',
        '가능합니다. 그러나 각 국가에서 요구하는 특정한 입학조건이 있을 경우 미리 준비해야 합니다. 예를 들어 미국과 같은 경우 우수한 대학들은 대부분 SAT 점수를 요구하기 때문에 SAT 시험을 미리 준비해야 하며, 이는 한국에서 해외대학으로 진학할 때도 마찬가지 입니다.',
        'after australia high school university america',
        '가능합니다. 그러나 각 국가에서 요구하는 특정한 입학조건이 있을 경우 미리 준비해야 합니다. 예를 들어 미국과 같은 경우 우수한 대학들은 대부분 SAT 점수를 요구하기 때문에 SAT 시험을 미리 준비해야 하며, 이는 한국에서 해외대학으로 진학할 때도 마찬가지 입니다.',
...
def search(entered_input):
      ...
      if haystack.find('toefl')>=0 and haystack.find('admission')>=0:
            haystack='toefl for admission'
      elif haystack.find('toefl')>=0:
            haystack='toefl score'
      elif haystack.find('ielts')>=0:
            haystack='ielts score'
      elif haystack.find('university')>=0 and haystack.find('without')>=0 and haystack.find('ielts')>=0:
            haystack='english university without IELTS'
      elif haystack.find('university')>=0 and haystack.find('without')>=0 and haystack.find('toefl')>=0:
            haystack='english university without TOEFL'
            ...
            haystack='lower engish score'
      elif haystack.find('english')>=0:
            haystack='not enough engish score'
      ...
      elif haystack.find('working')>=0 and haystack.find('holiday')>=0 and haystack.find('visa')>=0 and (haystack.find('long')>=0 or haystack.find('duration')>=0 or haystack.find('period')>=0):
      ...
      elif (haystack.find('work')>=0 or haystack.find('job')>=0) and haystack.find('after')>=0 and haystack.find('graduate')>=0:
            haystack='work after graduate'
      elif haystack.find('international')>=0 and haystack.find('high school')>=0:
            haystack='international student high school'
      elif haystack.find('international')>=0 and haystack.find('middle')>=0:
            haystack='international student middle school'
      elif (haystack.find('best')>=0 or haystack.find('rank')>=0 or haystack.find('prestigious')>=0  or haystack.find('level')>=0  or haystack.find('good')>=0) and haystack.find('universit')>=0:
            haystack='prestigious australian university'
      elif haystack.find('recommend')>=0 and haystack.find('universit')>=0:
            haystack='recommend universit'
            ...
            haystack='finish high school in korea australia university'
      ...
      elif haystack.find('tuition')>=0 or  haystack.find('university cost')>=0:
            haystack='universit cost'
      elif haystack.find('fee')>=0:
            haystack='tuition fee'
      elif haystack.find('study abroad')>=0 or (haystack.find('study')>=0 and haystack.find('foreign')>=0):
      ...
      elif haystack.find('abroad')>=0 or haystack.find('foreign')>=0:
            haystack='abroad'
      elif haystack.find('overseas')>=0:
            haystack='abroad'
      elif haystack.find('application')>=0:
            haystack='application deadline'
      elif haystack.find('iae eduhouse')>=0 and (haystack.find('iae eduhouse')>=0):
            haystack='iae eduhouse'
